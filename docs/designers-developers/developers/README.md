...
Before you start developing Gutenberg blocks you will need to install some tools to help with the process. You will also need to install [node.js and some build packages](/docs/designers-developers/developers/tutorials/javascript/js-build-setup.md) to compile your Gutenberg code for the browser.

You may also want to make some configuration changes to WordPress itself. To get more informative console debug messages, you may want to [enable `SCRIPT_DEBUG` in your wp-config.php](https://wordpress.org/support/article/debugging-in-wordpress/#script_debug).
